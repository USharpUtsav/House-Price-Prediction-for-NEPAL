...
with open(r'D:\HOUSEPRICE\houseprice\prediction\best_rf_model.pkl', 'rb') as model_file:
    best_rf_model = pickle.load(model_file)
    print(type(best_rf_model))  # Ensure this is a valid RandomForest model

with open(r'D:\HOUSEPRICE\houseprice\prediction\scaler.pkl', 'rb') as scaler_file:
